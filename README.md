...
reactive, cross-service, and cross-request stored injection — **37 of 38 vulnerable
...
The benchmark has **41 cases (38 vulnerable, 3 safe)** across SQL and JPQL injection
...
Current engine result: **37 of 38 vulnerable cases detected by the taint engine alone,
0 false positives** on the 3 safe cases; the near-miss layer (`--src`) catches the
remaining wrong-context flow (38) and explains the rest. Full table: [benchmark README](spring-taint-benchmark/README.md).
